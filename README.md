# <img src="https://github.com/Marlinsk/simple-backend-node/blob/main/.github/key.png" width="56px" height="56px"> Projeto de autenticação utilizando JWT e refresh token
